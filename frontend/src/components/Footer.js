      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              Project Maintainer:{' '}
              <Link href="https://github.com/Ushakudale1511" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f57c00' } }}>
                Usha kudale
              </Link>
            </Typography>
            <Typography variant="body2">
              Email:{' '}
              <Link href="mailto:kudaleusha61@gmail.com" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f57c00' } }}>
                kudaleusha61@gmail.com
              </Link>
            </Typography>
